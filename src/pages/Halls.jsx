...
const halls = [
  { id: 1, name: 'Кінозал 1', layout: 'Класична архітектура з 9 рядами по 8 місць' },
  { id: 2, name: 'Кінозал 2', layout: 'VIP зал з м’якими кріслами, 6 рядів по 8 місць' },
  { id: 3, name: 'Кінозал 3', layout: 'ІМАКС-зал з великим екраном, 12 рядів по 8 місць' },
  { id: 4, name: 'Кінозал 4', layout: 'Міні-зал для артхаусних фільмів, 5 рядів по 8 місць' }
];
